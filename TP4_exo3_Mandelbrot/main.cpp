...
int main()
{
    auto ctx = p6::Context{{800, 800, "Mandelbrot"}};
    // ctx.maximize_window();
    ...
    Vertex2DColor vertices[] = {
        Vertex2DColor{{-1, -1}, {1.f, 1.f, 1.f}}, // Sommet 0
        Vertex2DColor{{1, -1}, {1.f, 1.f, 1.f}},  // Sommet 1
        Vertex2DColor{{1, 1}, {1.f, 1.f, 1.f}},   // Sommet 2
        Vertex2DColor{{-1, 1}, {1.f, 1.f, 1.f}},  // Sommet 3
    };
